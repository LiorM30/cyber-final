...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.remove_filter_button.setGeometry(QtCore.QRect(680, 300, 31, 31))
        ...
        self.s_status.setGeometry(QtCore.QRect(660, 50, 47, 13))
        self.s_status.setObjectName("s_status")
        self.scrollArea = QtWidgets.QScrollArea(self.centralwidget)
        self.scrollArea.setGeometry(QtCore.QRect(640, 70, 231, 221))
        ...
        self.add_filter_button.setGeometry(QtCore.QRect(650, 300, 31, 31))
        ...
        self.frame.setGeometry(QtCore.QRect(20, 80, 551, 251))
        self.frame.setFrameShape(QtWidgets.QFrame.Shape.StyledPanel)
        self.frame.setFrameShadow(QtWidgets.QFrame.Shadow.Raised)
        self.frame.setLineWidth(10)
        self.frame.setObjectName("frame")
        self.verticalLayoutWidget_2 = QtWidgets.QWidget(self.frame)
        self.verticalLayoutWidget_2.setGeometry(QtCore.QRect(0, -10, 551, 271))
        self.verticalLayoutWidget_2.setObjectName("verticalLayoutWidget_2")
        self.packets_layout = QtWidgets.QVBoxLayout(self.verticalLayoutWidget_2)
        self.packets_layout.setContentsMargins(0, 0, 0, 0)
        self.packets_layout.setObjectName("packets_layout")
        self.label = QtWidgets.QLabel(self.verticalLayoutWidget_2)
        self.label.setObjectName("label")
        self.packets_layout.addWidget(self.label)
        self.frame_2 = QtWidgets.QFrame(self.centralwidget)
        self.frame_2.setGeometry(QtCore.QRect(20, 350, 551, 131))
        self.frame_2.setFrameShape(QtWidgets.QFrame.Shape.StyledPanel)
        self.frame_2.setFrameShadow(QtWidgets.QFrame.Shadow.Raised)
        self.frame_2.setObjectName("frame_2")
        self.verticalLayoutWidget_3 = QtWidgets.QWidget(self.frame_2)
        self.verticalLayoutWidget_3.setGeometry(QtCore.QRect(0, 0, 551, 131))
        self.verticalLayoutWidget_3.setObjectName("verticalLayoutWidget_3")
        self.packet_info_layout = QtWidgets.QVBoxLayout(self.verticalLayoutWidget_3)
        self.packet_info_layout.setContentsMargins(0, 0, 0, 0)
        self.packet_info_layout.setObjectName("packet_info_layout")
        self.label_2 = QtWidgets.QLabel(self.verticalLayoutWidget_3)
        self.label_2.setObjectName("label_2")
        self.packet_info_layout.addWidget(self.label_2)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "will see packets here"))
        self.label_2.setText(_translate("MainWindow", "packet raw data view"))
